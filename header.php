...
/*   
        ...
        #top-header {
            ...
            background: linear-gradient(to right, #1010100A, #560000); /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */
			...
			<div id="top-header">
				<div class="container">
					<ul class="header-links pull-left">
						<li><a href="#"><i class="fa fa-phone"></i> +96605455454</a></li>
						<li><a href="#"><i class="fa fa-envelope-o"></i>ٍshop@gmail.com</a></li>
						<li><a href="#"><i class="fa fa-map-marker"></i>Makkah</a></li>
					</ul>
