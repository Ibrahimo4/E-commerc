					...
					<div class="col-md-12">
						...
						<div class="newsletter">
							...
							<ul class="newsletter-follow">
								<li>
									<a href="https://makkah.com/supportreddyhc"><i class="fa fa-facebook"></i></a>
								</li>
								<li>
									<a href="https://m.com/supportreddyhc"><i class="fa fa-twitter"></i></a>
								</li>
								<li>
									<a href="https://mm.com/supportreddyhc"><i class="fa fa-instagram"></i></a>
								</li>
								<li>
									<a href="https://mmmm.com/supportreddyhc"><i class="fa fa-github"></i></a>
								</li>
							</ul>
						</div>
					</div>
